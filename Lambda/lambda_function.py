...
def validate_data(first_name, age, income_amount, debt_amount, investment_amount, risk_level, intent_request):
    ...
    if first_name is not None:
        if not first_name.isalpha():
            return build_validation_result(False, 'firstName', "Please provide your first name again. This should only consists of letters, and it cannot include numbers and/or special characters.")
    ...
    if income_amount is not None:
        ...
        if not is_income_amount_valid:
            ...
            message = "The amount you entered did not qualify for this service. We require a minimum of $130,000 annual income. Please provide a new income amount." 
    ...
    if debt_amount is not None:
        ...
        if not is_debt_amount_valid:
            ...
            message = f"Your debt-to-income ratio is greater than the average. To qualify for this service, your debt needs to be less than {int(debt_percentage*100)}% of your income. Please provide a different amount." 
    ...
    if investment_amount is not None:
        ...
        #income_amount = parse_int(income_amount)
        is_investment_amount_valid = investment_amount >= 25000 and investment_amount < income_amount
        if not is_investment_amount_valid:
            violatedSlot = "investmentAmount"
            message = f"The amount you entered did not qualify for this service. We require a minimum of $25,000 investment that is less than your ${int(income_amount)} annual income. Please provide a new investment amount." 
